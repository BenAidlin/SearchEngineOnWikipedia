INSTANCE_NAME="shahar-ben-instance"
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="ir-project-313191645-206013310"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="ben.aidlin" # without the @post.bgu.ac.il or @gmail.com part
...
'''
gcloud compute instances create "default-allow-http-8080" --zone="us-central1-c" --machine-type=e2-micro --network-interface=address="35.202.40.87",network-tier=PREMIUM,subnet=default --metadata-from-file startup-script="C:\Users\baidlin\OneDrive - Intel Corporation\Desktop\Studies\IR\FinalProject\SearchEngineOnWikipedia\ir_proj\startup_script_gcp.sh" --scopes=https://www.googleapis.com/auth/cloud-platform --tags=http-server
'''
...
gcloud compute scp /home/ben_aidlin/search_frontend_gcp.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
gcloud compute scp /home/ben_aidlin/helper_functions.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
gcloud compute scp /home/ben_aidlin/inverted_index_gcp.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME

# 5. SSH to your VM and start the app
gcloud compute ssh $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME
python3 search_frontend_gcp.py
